...
I am a results-driven **Software Architect & Senior Full Stack Developer** with over **8 years of experience**, specializing in building **mission-critical**, **scalable**, and **high-performance** digital ecosystems.

My expertise goes beyond code; I design resilient architectures that bridge **complex backend logic**, **geospatial intelligence (GIS)**, and **intuitive mobile experiences**. I focus on creating sovereign solutions where performance and data security are the priority.

I thrive in leading technical teams and collaborating globally to deliver impactful solutions that solve real-world problems.
...
![Nginx](https://img.shields.io/badge/-Nginx_Server-009639?style=flat&logo=nginx&logoColor=white) 
